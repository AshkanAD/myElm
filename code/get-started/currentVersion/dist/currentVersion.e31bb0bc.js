...
var author$project$Main$main = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					A2(author$project$Main$viewDetailedPhoto, author$project$Main$baseUrl + '1.jpg', 'Surfing'),
					A2(author$project$Main$viewDetailedPhoto, author$project$Main$baseUrl + '2.jpg', 'The Fox'),
					A2(author$project$Main$viewDetailedPhoto, author$project$Main$baseUrl + '3.jpg', 'Evening')
				]))
		]));
...
var root = require("./src/Main.elm");

var app = root.Elm.Main.init({
  node: document.getElementById('elm-node')
});
},{"./src/Main.elm":"src/Main.elm"}],"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
